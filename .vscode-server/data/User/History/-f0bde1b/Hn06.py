...
pi = np.pi*2                  # utilize the numpy library to define pi
...
motions = [
    [0.25, 0.0*pi, 2],            # Motion 1
    [0.0, 0.25*pi, 1],            # Motion 2
    [0.25, 0.0*pi, 3],            # Motion 3
    [0.0, 0.25*pi, 1],            # Motion 4
    [0.25, 0.0*pi, 2],            # Motion 5
    [0.0, -0.25*pi, 1],            # Motion 6
    [0.25, 0.0*pi, 3],            # Motion 7
    [0.0, -0.2*pi, 1],            # Motion 8
    [0.25, 0.0*pi, 2],            # Motion 9
    [0.0, 0.0*pi, 1],            # Motion 10
]
