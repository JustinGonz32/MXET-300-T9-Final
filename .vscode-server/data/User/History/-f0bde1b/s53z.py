...
motions = [
    [forward_velocity, 0.0*pi, 2],            # Motion 1
    [0, 0.25*pi, 1],            # Motion 2
    [forward_velocity, 0.0*pi, 3],            # Motion 3
    [0, 0.25*pi, 1],            # Motion 4
    [forward_velocity, 0.0*pi, 2],            # Motion 5
    [0, -0.25*pi, 1],            # Motion 6
    [forward_velocity, 0.0*pi, 3],            # Motion 7
    [0, -0.2*pi, 1],            # Motion 8
    [forward_velocity, 0.0*pi, 2],            # Motion 9
    [0, 0.0*pi, 1],            # Motion 10
]
