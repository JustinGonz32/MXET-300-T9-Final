...
def draw_star(scale_factor):
    ...
    motions = [
        ...
        [forward_velocity, 0, forward_motion_duration],        # Motion 11: Move forward
...
def draw_square(scale_factor):
    side_length_scaled = side_length * scale_factor  # Adjust the side length based on the scale factor
    forward_motion_duration = side_length_scaled / forward_velocity  # Calculate the forward motion duration based on the adjusted side length
    motions = [
        [forward_velocity, 0, forward_motion_duration],        # Motion 1: Move forward
        [0, -quarter_turn, 1 * scale_factor],             # Motion 2: Rotate a quarter turn
        [forward_velocity, 0, forward_motion_duration],        # Motion 3: Move forward
