...
complete -c pybuild -l print --description 'print pybuild\\(aqs internal parameters.'
...
complete -c pybuild -l test-tox --description 'use tox command in test step, remember to add tox to Build-Depends.'
...
complete -c pybuild -l ext-sub-pattern --description 'regular expression for part of path/filename matched in --ext-pattern that sh…'
complete -c pybuild -l ext-sub-repl --description 'replacement for matches in --ext-sub-pattern.'
