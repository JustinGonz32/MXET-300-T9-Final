...
complete -c dhcpcd5 -s D --description 'Use a DHCP Unique Identifier.'
...
complete -c dhcpcd5 -l lastleaseextend --description 'Same as the above, but the lease will be retained even if it expires.'
