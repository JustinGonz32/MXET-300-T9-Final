...
def getVoltage():
    ...
    return var_volt # Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((40, 0), "Scuttle-Buddy", font=font, fill=255)
    ...
    volt_in = getVoltage()
    volt_out = "Robot Voltage: " + str(volt_in) + "V"
    draw.text((0, 40), volt_out, font=font, fill=255)
